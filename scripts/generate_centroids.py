...
if __name__ == '__main__':
    ...
    dump_mol_db(config, input_db['bucket'], f'{databases_path}/mol_db1.pickle', 22)  # HMDB-v4
    dump_mol_db(config, input_db['bucket'], f'{databases_path}/mol_db2.pickle', 19)  # ChEBI-2018-01
    dump_mol_db(config, input_db['bucket'], f'{databases_path}/mol_db3.pickle', 24)  # LipidMaps-2017-12-12
    dump_mol_db(config, input_db['bucket'], f'{databases_path}/mol_db4.pickle', 26)  # SwissLipids-2018-02-02
